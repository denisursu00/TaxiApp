...
import { DspActivitateAttachmentViewModel } from "./dsp-activitate-attachment-view.model";

@JsonObject
export class DspActivitateViewModel {
	...
	@JsonProperty("attachments", [DspActivitateAttachmentViewModel])
	public attachments: DspActivitateAttachmentViewModel[] = [];
}