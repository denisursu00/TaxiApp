import { JsonObject, JsonProperty, JsonConverter } from "json2typescript";
...
import { ProjectComisieSauGlViewModel } from "./project-comisie-sau-gl-view.model";
...
export class ProjectViewModel {
	...
	@JsonProperty("comisiiSauGl", [ProjectComisieSauGlViewModel])
