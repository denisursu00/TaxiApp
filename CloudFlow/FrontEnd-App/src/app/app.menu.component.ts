...
import { TranslateUtils, ArrayUtils } from "@app/shared";
...
export class AppMenuComponent implements OnInit, AfterViewInit {
	...
	constructor(public app: AppComponent, translateUtils: TranslateUtils, authManager: AuthManager, menuService: AppMenuService) {
