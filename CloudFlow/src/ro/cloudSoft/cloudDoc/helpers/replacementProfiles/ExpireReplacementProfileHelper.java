 ...
 * 
 */
public class ExpireReplacementProfileHelper extends ExpireOrReturnedReplacementProfileHelper {

	public ExpireReplacementProfileHelper(ReplacementProfile replacementProfile, DocumentService documentService, WorkflowExecutionService workflowExecutionService,
		...
		super(
			...
			replacementProfile,
			ReplacementProfileStatusOption.EXPIRED,
