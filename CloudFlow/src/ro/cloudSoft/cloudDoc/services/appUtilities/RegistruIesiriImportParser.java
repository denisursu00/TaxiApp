...
public class RegistruIesiriImportParser {
	private static final String SHEET_NAME_ATASAMANTE = "Atasamante registru iesiri";

	private static List<ColumnMapping> atasamenteSheetColumnMapping = new ArrayList<>();
	static {
		atasamenteSheetColumnMapping.add(new ColumnMapping("Numar inregistrare registru iesiri * ", "nrRegistruIesiri", ColumnMapping.ColumnValueType.String, null, true, null));
	...
	public RegistruIesiriImportParser(String excelFilePath) {
	...
	public RegistruIesiriAllXlsModel parse() throws AppUtilitiesException {
		RegistruIesiriAllXlsModel model = new RegistruIesiriAllXlsModel();
		try {
			
			init();
			List<RegistruIesiriAtasamentXlsModel> atasamenteSheetModels = (List<RegistruIesiriAtasamentXlsModel>) parseSheet(SHEET_NAME_ATASAMANTE, RegistruIesiriAtasamentXlsModel.class, atasamenteSheetColumnMapping);
