...
public class RegistruDocumenteJustificativePlatiImportParser {

	private static final String SHEET_NAME_ATASAMANTE = "Atasamente registru facturi";

	private static List<ColumnMapping> atasamenteSheetColumnMapping = new ArrayList<>();
	static {
		atasamenteSheetColumnMapping.add(new ColumnMapping("Numar inregistrare registru facturi *", "nrDocumenteJustificativePlati", ColumnMapping.ColumnValueType.String, null, true, null));
	...
	public RegistruDocumenteJustificativePlatiImportParser(String excelFilePath) {
	...
	public RegistruDocumenteJustificativePlatiAllXlsModel parse() throws AppUtilitiesException {
		RegistruDocumenteJustificativePlatiAllXlsModel model = new RegistruDocumenteJustificativePlatiAllXlsModel();
		try {
			
			init();
			List<RegistruDocumenteJustificativePlatiAtasamentXlsModel> atasamenteSheetModels = (List<RegistruDocumenteJustificativePlatiAtasamentXlsModel>) parseSheet(SHEET_NAME_ATASAMANTE, RegistruDocumenteJustificativePlatiAtasamentXlsModel.class, atasamenteSheetColumnMapping);
