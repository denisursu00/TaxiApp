...
public class CerereConcediuNepersonalActualizareDateCuPrivireLaZileleDeConcediu extends AutomaticTask {
	...
	public void execute(WorkflowInstance workflowInstance) throws AutomaticTaskExecutionException {
		...
		String tipConcediu = DocumentUtils.getMetadataValueAsString(document, cerereConcediuDocumentType, getDocumentCerereConcediuConstants().getTipConcediuNepersonalMetadataName());
