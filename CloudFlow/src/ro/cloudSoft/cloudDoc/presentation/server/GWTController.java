package ro.cloudSoft.cloudDoc.presentation.server;

import static ro.cloudSoft.cloudDoc.core.AppExceptionCodes.APPLICATION_ERROR;
import static ro.cloudSoft.cloudDoc.presentation.client.shared.exceptions.PresentationExceptionCodes.UNAUTHENTICATED;
