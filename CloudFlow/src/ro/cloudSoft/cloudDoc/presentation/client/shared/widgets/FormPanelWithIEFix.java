...
public class FormPanelWithIEFix extends FormPanel {
    ...
    private Element createFixedFrame() {
        ...
        DOM.setInnerHTML(dummy, "<iframe src=\"javascript:''\" name='" + getFrameName() + "' style='position:absolute;width:0;height:0;border:0'>");
