...
public class ParameterAssignmentHandler extends BaseAssignmentHandler {
	
	private static final long serialVersionUID = 4933759906077565495L;
	
	private final static LogHelper LOGGER = LogHelper.getInstance(ParameterAssignmentHandler.class);
	...
	public void assign(Assignable assignable, OpenExecution execution) throws Exception {
		...
		assignToUser(execution, assignable, userIdFromMetadataValue);
	}
