...
public class NumarSedinteCdPvgSiParticipantiDocumentReportSearcher {
	
	private final Repository repository;
	private final Credentials credentials;
	private final NumarSedinteCdPvgSiParticipantiReportFilterModel filter;
	private final ArbConstants arbConstants;
	private final DocumentTypeService documentTypeService;
	
	private DocumentType documentType;
	
	public NumarSedinteCdPvgSiParticipantiDocumentReportSearcher(Repository repository, Credentials credentials, NumarSedinteCdPvgSiParticipantiReportFilterModel filter,
