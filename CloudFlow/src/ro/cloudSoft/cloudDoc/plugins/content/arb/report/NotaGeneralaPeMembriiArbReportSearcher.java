...
public class NotaGeneralaPeMembriiArbReportSearcher {

	private final Repository repository;
	private final Credentials credentials;
	private final NotaGeneralaPeMembriiArbReportFilterModel filter;
	private final ArbConstants arbConstants;
	private final DocumentTypeService documentTypeService;
	
	private DocumentType documentType;
	
	public NotaGeneralaPeMembriiArbReportSearcher(Repository repository, Credentials credentials,
			NotaGeneralaPeMembriiArbReportFilterModel filter, ArbConstants arbConstants,
