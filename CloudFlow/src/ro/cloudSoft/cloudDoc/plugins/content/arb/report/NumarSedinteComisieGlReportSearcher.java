...
public class NumarSedinteComisieGlReportSearcher {

	private final Repository repository;
	private final Credentials credentials;
	private final NumarSedinteComisieGlReportFilterModel filter;
	private final ArbConstants arbConstants;
	private final DocumentTypeService documentTypeService;
	
	private DocumentType documentType;
	
	public NumarSedinteComisieGlReportSearcher(Repository repository, Credentials credentials,
			NumarSedinteComisieGlReportFilterModel filter, ArbConstants arbConstants,
	...
	private Query createQuery(Session session) throws RepositoryException {
		...
		if (filter.getDocument() != null && filter.getDocument().getDocumentId() != null) {
			query.bindValue("documentId", session.getValueFactory().createValue(filter.getDocument().getDocumentId().toString()));
		}
