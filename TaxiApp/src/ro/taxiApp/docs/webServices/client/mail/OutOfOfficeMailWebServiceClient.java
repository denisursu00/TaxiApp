...
public interface OutOfOfficeMailWebServiceClient {
    ...
    @RequestWrapper(
		...
		className = "ro.taxiApp.docs.webServices.client.mail.RESETOOOSTATUS"
	)
    @ResponseWrapper(
		localName = "RESETOOOSTATUSResponse", targetNamespace = "urn:DefaultNamespace",
		className = "ro.taxiApp.docs.webServices.client.mail.RESETOOOSTATUSResponse"
	)
    ...
    @RequestWrapper(
		...
		className = "ro.taxiApp.docs.webServices.client.mail.SETOOOSTATUS"
	)
    @ResponseWrapper(
		localName = "SETOOOSTATUSResponse", targetNamespace = "urn:DefaultNamespace",
		className = "ro.taxiApp.docs.webServices.client.mail.SETOOOSTATUSResponse"
	)
